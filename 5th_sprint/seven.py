...
assert Contact('friend', 1945, True).age_define() == 'Старейшина', ' (('
assert Contact('friend', 1945, True).programmer_define() == 'Программист', ' (('

assert Contact('friend', 1979, True).age_define() == 'Олдскул', ' (('
assert Contact('friend', 1979, True).programmer_define() ==  'Программист', ' (('
...
assert Contact('friend', 1980, False).age_define() == 'Молодой', ' (('
assert Contact('friend', 1980, False).programmer_define() == 'Нормальный', ' (('
# (1981, False): ['Молодой', 'Нормальный'],